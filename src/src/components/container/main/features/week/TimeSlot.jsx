                    ...
                    <div className="appointment-actions">
                        {!slot.appointment.confirmAppointment && (
                            <button 
                                ...
                                onClick={(e) => handleConfirmClick(e, slot, setTimeSlots, setError)}
                            >
                                Confirmar
                            </button>
                        )}
                        {slot.appointment.confirmAppointment && slot.status !== 'completed' && (
                            <button 
                                className="complete-button" 
                                onClick={(e) => handleComplete(e, slot, setTimeSlots, setError)}
                            >
                                Completar
                            </button>
                        )}
                        {slot.appointment.confirmAppointment && (
                            <button 
                                ...
                                onClick={(e) => handleReassignClick(e, slot, selectedDate, setTimeSlots, setError)}
                            >
                                Reasignar
                            </button>
                        )}
